...
class Db {
     ...
     * @since 0.2
     *
     * @param string $mod           Название мода.
     * @param int    $user_id       Номер пользователя.
     * @param int    $db_id         Номер подключенной базы данных.
     * @param string $sql           SQL запрос.
     * @param array  $params        Параметры.
     *
     * @return PDOStatement|false   Результат выполнения запроса или false в случае ошибки.
     */
    ...
    /**
     * Шаблон запроса отдающий массив с первыми индексированными именами столбцов.
     *
     * @since 0.2
     *
     * @param  array   $mod           Навание мода.
     * @param  array   $sql           SQL запрос.
     * @return array                  Возвращает результат SQL запроса.
     */
    public function queryFirst($mod, $sql) {
        ...
        if (file_exists($filePath)) {
            ...
            if (is_array($data)) { $data[] = $updatesql; } else { $data = array($updatesql); }
