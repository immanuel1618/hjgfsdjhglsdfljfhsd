<div class="col-md-12">
	<select style="display: none;" class="custom-select" onchange="window.location.href=this.value" placeholder="<?= $Translate->get_translate_module_phrase('module_page_adminpanel', '_Logs_engine'); ?>">
		...
		<div class="card">
			<div class="card-header">
				<h5 class="badge"><?= $Translate->get_translate_module_phrase('module_page_pay', '_LogContent'); ?>
					<div class="copy_log" data-clipboard-text="<?= file_get_contents(__DIR__ . '/../../../logs/' . $_GET['log']) ?>">
