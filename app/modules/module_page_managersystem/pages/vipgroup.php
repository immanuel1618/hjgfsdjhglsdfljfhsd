    ...
    <div class="fix_grid">
        ...
        <svg viewBox="0 0 512 512"><path d="M40 48C26.7 48 16 58.7 16 72v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V72c0-13.3-10.7-24-24-24H40zM192 64c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zM16 232v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V232c0-13.3-10.7-24-24-24H40c-13.3 0-24 10.7-24 24zM40 368c-13.3 0-24 10.7-24 24v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V392c0-13.3-10.7-24-24-24H40z"/></svg>
            <div class="container_text_settings_text">
                ...
                <span class="settings_header_text_bottom"><?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSListFormVip') ?></span>
            </div>
        </div>
            ...
            <div class="flex_column_gap table_4_scroll scroll">
                <?php foreach ($Core->GetCache('vipgroup') as $key) : ?>
                    <ul class="table_2_group_list">
                        <li>
                            <span class="col_1"><?= action_text_clear(action_text_trim($key['name_group'], 30)) ?></span>
                            <span class="col_2">
                                <button class="btn_del_table" id="ms_vip_group_del" id_del="<?= $key['id'] ?>"><?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSDelGroup') ?></button>
                            </span>
                        </li>
                    </ul>
                <?php endforeach ?>
    ...
    <form id="ms_vip_group_add">
        ...
        <svg viewBox="0 0 576 512"><path d="M264.5 5.2c14.9-6.9 32.1-6.9 47 0l218.6 101c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L45.9 149.8C37.4 145.8 32 137.3 32 128s5.4-17.9 13.9-21.8L264.5 5.2zM476.9 209.6l53.2 24.6c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L45.9 277.8C37.4 273.8 32 265.3 32 256s5.4-17.9 13.9-21.8l53.2-24.6 152 70.2c23.4 10.8 50.4 10.8 73.8 0l152-70.2zm-152 198.2l152-70.2 53.2 24.6c8.5 3.9 13.9 12.4 13.9 21.8s-5.4 17.9-13.9 21.8l-218.6 101c-14.9 6.9-32.1 6.9-47 0L45.9 405.8C37.4 401.8 32 393.3 32 384s5.4-17.9 13.9-21.8l53.2-24.6 152 70.2c23.4 10.8 50.4 10.8 73.8 0z"/></svg>
            <div class="container_text_settings_text">
                ...
                <span class="settings_header_text_bottom"><?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSFormVipDesc') ?></span>
            </div>
        </div>
            ...
            <div class="h411_max scroll">
                <div class="input_container">
                    ...
                    <div class="input_wrapper">
                        <span data-tippy-content="<?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSNameGroupVip') ?>" data-tippy-placement="right">
