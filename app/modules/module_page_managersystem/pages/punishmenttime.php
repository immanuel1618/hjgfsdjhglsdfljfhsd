<div class="container_grid">
    <div class="fix_grid">
        <div class="container_text_access">
            ...
            <div class="container_text_settings_text">
                ...
                <span
                    class="settings_header_text_bottom"><?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSListTimeDesc') ?></span>
            </div>
        </div>
                ...
                <?php foreach ($Core->GetCache('punishmenttime') as $key): ?>
                    <ul class="table_3_group_list">
                        <li>
                            ...
                            <span class="col_3">
                                <button class="btn_del_table" id="ms_punishment_time_del"
    ...
    <form id="ms_punishment_time_add">
