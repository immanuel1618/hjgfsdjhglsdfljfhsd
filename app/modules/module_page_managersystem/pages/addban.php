        ...
        <div class="container_grid">
            <div class="fix_grid">
                <div class="container_text_access">
                    ...
                    <div class="container_text_settings_text">
                        ...
                        <span class="settings_header_text_bottom"><?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSListNaacazDesc') ?></span>
                    </div>
                </div>
                <div class="card_settings">
                    <input class="input_search" name="search" id="search_table_ban" placeholder="<?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSPoisk') ?>">
                    <div class="h346 scroll">
                        ...
                        <div class="flex_table_proff" id="table_list_foreach">
                            <?php foreach ($MSBan as $key) : ?>
                                <div class="user_card_bg">
                                    <div class="user_flex_av_nn">
                                        <?php $General->get_js_relevance_avatar($key['steamid'], 1) ?>
                                        <a href="<?= $General->arr_general['site'] ?>profiles/<?= $key['steamid'] ?>/?search=1"><img class="avatar_img" id="<?php if ($General->arr_general['theme'] == 'neo') {
                                                                                                                                                                echo 'avatar';
                                                                                                                                                            } else {
                                                                                                                                                                echo $key['steamid'];
                                        ...
                                        <div class="info_nn">
                                            ...
                                            <a class="info_a" href="<?= $General->arr_general['site'] ?>profiles/<?= $key['steamid'] ?>/?search=1"><?= empty($General->checkName($key['steamid'])) ? htmlspecialchars(action_text_trim($key['name'], 30)) : htmlspecialchars(action_text_trim($General->checkName($key['steamid']), 30)) ?></a>
                                        </div>
                                        <div class="info_deff">
                                        ...
                                        <button class="btn_req" id="ms_ban_unban" id_del="<?= $key['steamid'] ?>" id_end="<?= $key['id'] ?>" data-tippy-content="<?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSUnBan1') ?>" data-tippy-placement="top">
                                        ...
                                        <button class="btn_del" id="ms_ban_del" id_del="<?= $key['steamid'] ?>" id_end="<?= $key['id'] ?>" data-tippy-content="<?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSDelBan') ?>" data-tippy-placement="top">
                                            <svg viewBox="0 0 448 512">
            ...
            <form id="ms_ban_add">
                <div class="container_text_access2">
                    ...
                    <div class="container_text_settings_text">
                        <span class="settings_header_text_top"><?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSAddBan') ?></span>
                        <span class="settings_header_text_bottom"><?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSFormAddBan') ?></span>
                    </div>
                </div>
                <div class="card_settings">
                    <div class="h411_max scroll">
                        ...
                        <div class="input_container">
                            <div class="input_form">
                                <div class="input_text">
                                    ...
                                    <?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSIPPlay') ?>
                                </div>
                            </div>
                            <div class="input_wrapper">
                                <span data-tippy-content="<?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSIPSTEAMDesc') ?>" data-tippy-placement="right">
                                    <svg viewBox="0 0 512 512">
                                        <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM169.8 165.3c7.9-22.3 29.1-37.3 52.8-37.3h58.3c34.9 0 63.1 28.3 63.1 63.1c0 22.6-12.1 43.5-31.7 54.8L280 264.4c-.2 13-10.9 23.6-24 23.6c-13.3 0-24-10.7-24-24V250.5c0-8.6 4.6-16.5 12.1-20.8l44.3-25.4c4.7-2.7 7.6-7.7 7.6-13.1c0-8.4-6.8-15.1-15.1-15.1H222.6c-3.4 0-6.4 2.1-7.5 5.3l-.4 1.2c-4.4 12.5-18.2 19-30.6 14.6s-19-18.2-14.6-30.6l.4-1.2zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"></path>
                                    </svg>
                                </span>
                                <input type="text" name="ip" placeholder="111.111.111.111">
                            </div>
                        </div>
                        ...
                        <?php endif; ?>
                        <?php if ($Core->GetCache('settings')['reason_ban'] == 1) : ?>
                            <?php if (!empty($Core->GetCache('reasonban'))) : ?>
                                <div class="input_container">
                                    <div class="input_form">
                                        <div class="input_text">
                                            <svg viewBox="0 0 512 512">
                                            ...
                                            <?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSReasoneCoose') ?>
                                        </div>
                                    </div>
                                    <div class="card_button_flex_more_res">
                                        <?php foreach ($Core->GetCache('reasonban') as $key) : ?>
                                            <div class="check_button_card">
                                                <input class="radio__input" type="radio" name="reason_ban" id="reason_ban<?= $key['id'] ?>" value="<?= $key['id'] ?>">
                                                <label for="reason_ban<?= $key['id'] ?>" class="custom-radio"><?= action_text_trim($key['reason_name'], 45) ?></label>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            <?php else : ?>
                                <?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSNoRes') ?>
                            <?php endif; ?>
                        <?php else : ?>
                            <div class="input_container">
                                <div class="input_form">
                                    <div class="input_text">
                                        ...
                                        <?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSReasonBan') ?>
                                    </div>
                                </div>
                                <div class="input_wrapper">
                    ...
                    <input class="secondary_btn" type="submit" value="<?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSAddNewBan') ?>">
                </div>
            </form>
        </div>
    <?php break;
                            ...
                            <?php foreach ($MSBan as $key) : ?>
                                <div class="user_card_bg">
                                    <div class="user_flex_av_nn">
                                        ...
                                        <a href="<?= $General->arr_general['site'] ?>profiles/<?= $key['steam_id'] ?>/?search=1"><img class="avatar_img" id="<?php if ($General->arr_general['theme'] == 'neo') {
                                                                                                                                                                echo 'avatar';
                                                                                                                                                            } else {
                                                                                                                                                                echo $key['steam_id'];
                                                                                                                                                            } ?>" <?php if ($General->arr_general['theme'] == 'neo') {
                                        ...
                                        <div class="info_nn">
                                            ...
                                            <a class="info_a" href="<?= $General->arr_general['site'] ?>profiles/<?= $key['steam_id'] ?>/?search=1"><?= empty($General->checkName($key['steam_id'])) ? htmlspecialchars(action_text_trim($key['name'], 30)) : htmlspecialchars(action_text_trim($General->checkName($key['steam_id']), 30)) ?></a>
                                        </div>
                                        <div class="info_deff">
                                            <div class="svg_div" data-tippy-placement="top" data-tippy-content="STEAMID"><svg viewBox="0 0 496 512">
                                                    <path d="M496 256c0 137-111.2 248-248.4 248-113.8 0-209.6-76.3-239-180.4l95.2 39.3c6.4 32.1 34.9 56.4 68.9 56.4 39.2 0 71.9-32.4 70.2-73.5l84.5-60.2c52.1 1.3 95.8-40.9 95.8-93.5 0-51.6-42-93.5-93.7-93.5s-93.7 42-93.7 93.5v1.2L176.6 279c-15.5-.9-30.7 3.4-43.5 12.1L0 236.1C10.2 108.4 117.1 8 247.6 8 384.8 8 496 119 496 256zM155.7 384.3l-30.5-12.6a52.8 52.8 0 0 0 27.2 25.8c26.9 11.2 57.8-1.6 69-28.4 5.4-13 5.5-27.3 .1-40.3-5.4-13-15.5-23.2-28.5-28.6-12.9-5.4-26.7-5.2-38.9-.6l31.5 13c19.8 8.2 29.2 30.9 20.9 50.7-8.3 19.9-31 29.2-50.8 21zm173.8-129.9c-34.4 0-62.4-28-62.4-62.3s28-62.3 62.4-62.3 62.4 28 62.4 62.3-27.9 62.3-62.4 62.3zm.1-15.6c25.9 0 46.9-21 46.9-46.8 0-25.9-21-46.8-46.9-46.8s-46.9 21-46.9 46.8c.1 25.8 21.1 46.8 46.9 46.8z"></path>
                                        ...
                                        <div class="info_nn addmute_none">
                                            ...
                                            <?php if (!empty($key['admin_steamid']) && $key['admin_steamid'] != "CONSOLE"): ?>
                                                <a class="info_a" href="<?= $General->arr_general['site'] ?>profiles/<?= $key['admin_steamid'] ?>">
                                                    <?= empty($General->checkName($key['admin_steamid'])) ? htmlspecialchars(action_text_trim($key['admin_name'], 30)) : htmlspecialchars(action_text_trim($General->checkName($key['admin_steamid']), 30)) ?>
                                                </a>
                                            <?php else: ?>
                                                <a class="info_a">
                                                    CONSOLE
                                        ...
                                        <button class="btn_req" id="ms_ban_unban" id_del="<?= $key['steam_id'] ?>" id_end="<?= $key['id'] ?>" data-tippy-content="<?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSUnBan1') ?>" data-tippy-placement="top">
                                            <svg viewBox="0 0 448 512">
                                                <path d="M144 144c0-44.2 35.8-80 80-80c31.9 0 59.4 18.6 72.3 45.7c7.6 16 26.7 22.8 42.6 15.2s22.8-26.7 15.2-42.6C331 33.7 281.5 0 224 0C144.5 0 80 64.5 80 144v48H64c-35.3 0-64 28.7-64 64V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V256c0-35.3-28.7-64-64-64H144V144z" />
                                            </svg>
                                        </button>
                                        <button class="btn_del" id="ms_ban_del" id_del="<?= $key['steam_id'] ?>" id_end="<?= $key['id'] ?>" data-tippy-content="<?= $Translate->get_translate_module_phrase('module_page_managersystem', '_MSDelBan') ?>" data-tippy-placement="top">
                                            <svg viewBox="0 0 448 512">
                                                <path d="M284.2 0C296.3 0 307.4 6.848 312.8 17.69L320 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96H32C14.33 96 0 81.67 0 64C0 46.33 14.33 32 32 32H128L135.2 17.69C140.6 6.848 151.7 0 163.8 0H284.2zM31.1 128H416L394.8 466.1C393.2 492.3 372.3 512 346.9 512H101.1C75.75 512 54.77 492.3 53.19 466.1L31.1 128zM143 272.1L190.1 319.1L143 367C133.7 376.4 133.7 391.6 143 400.1C152.4 410.3 167.6 410.3 176.1 400.1L223.1 353.9L271 400.1C280.4 410.3 295.6 410.3 304.1 400.1C314.3 391.6 314.3 376.4 304.1 367L257.9 319.1L304.1 272.1C314.3 263.6 314.3 248.4 304.1 239C295.6 229.7 280.4 229.7 271 239L223.1 286.1L176.1 239C167.6 229.7 152.4 229.7 143 239C133.7 248.4 133.7 263.6 143 272.1V272.1z"></path>
                                            </svg>
                                        </button>
