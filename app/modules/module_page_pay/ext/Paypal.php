...
class Paypal extends Basefunction
{
  ...
  public function PPProcessPay($post = '')
  {
    ...
    if (strcmp($this->res, "VERIFIED") == 0) {
      ...
      $this->LkAddLog('_NewDonat', ['gateway' => 'PayPal', 'order' => $this->decod[1], 'course' => $this->Translate->get_translate_module_phrase('module_page_pay', '_AmountCourse'), 'amount' => $this->decod[2], 'steam' => $this->decod[3]]);
