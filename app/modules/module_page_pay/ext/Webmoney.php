...
class Webmoney extends Basefunction{
	...
	public function WBProcessPay($post){
		 ...
		 $this->LkAddLog('_NewDonat', ['gateway'=>'WebMoney','order'=>$this->decod[1], 'course'=>$this->Translate->get_translate_module_phrase('module_page_pay','_AmountCourse'), 'amount' => $this->decod[2], 'steam'=>$this->decod[3]]);
