...
if( isset( $_POST['table_install'] ) ) {
        ...
        header("Location: ".get_url(2)."pay/?section=gateways");
}
?>
<!doctype html>
<html lang="en">
...
<style>
    .badge {
        ...
        box-shadow: var(--span-back) 5px 5px;
    }
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_pay','_LKInstall')?></h5>
                </div>
                <?php if(!empty($table)):?>
                    <div class="card-container option_one">
                        <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_pay','_InstallTable')?> <?php echo $Translate->get_translate_module_phrase('module_page_pay','_LK')?></h5><br>
                        <?php echo $Translate->get_translate_module_phrase('module_page_pay','_ForWork')?><br>
                        <?php foreach($table as $tableKey => $val):?>
                            <b>`<?php echo $tableKey?>`</b><br>
                        <?php endforeach;?>
                        <form enctype="multipart/form-data" method="post">
                            <input class="btn" name="table_install" type="submit" value="<?php echo $Translate->get_translate_module_phrase('module_page_pay','_InstallBTN')?>">
                        </form>
                    </div>
               <?php else :?>
                <div class="card-container option_one">
                    <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_pay','_SettingsBD')?></h5><br>
                    <?php echo $Translate->get_translate_module_phrase('module_page_pay','_LKForInstall')?> <a href="https://hlmod.ru/resources/lichnyj-kabinet-1mpulse-core-modules.887/"><?php echo $Translate->get_translate_module_phrase('module_page_pay','_LK')?></a>
                    ...
                    <div class="input-form"><div class="input_text">Host: </div><input name="host" value="<?php echo $_POST['host']?>"></div>
                        ...
                        <div class="input-form"><div class="input_text">Table: </div><input placeholder="<?php echo $Translate->get_translate_module_phrase('module_page_pay','_Example')?>: lk" name="table" value="<?php echo $_POST['table']?>"></div>
                    ...
                    <?php if ( $db_check != 2 ):?>
                    <input class="btn" name="db_check" type="submit" form="db_check" value="<?php echo $Translate->get_translate_module_phrase('module_page_pay','_DBCheckBTN')?>">
                    <?php elseif( $db_check == 2 ):?>
                        <input class="btn" name="save_db" type="submit" form="db_check" value="<?php echo $Translate->get_translate_module_phrase('module_page_pay','_NextBTN')?>">
                    <?php endif;?>
                </div>
        <?php endif;?>
            </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-header">
                    <h5 class="badge"><?php echo $Translate->get_translate_module_phrase('module_page_pay','_Information')?></h5>
                ...
                <div class="card-container">
                    <?php echo $Translate->get_translate_module_phrase('module_page_pay','_Php')?> <?php if( PHP_VERSION >= '7' ) { echo '<div class="color-green">'  . PHP_VERSION . '</div>';} else { echo '<div class="color-red">'  . PHP_VERSION . '</div>
                    <div>'.$Translate->get_translate_module_phrase('module_page_pay','_PhpRecomendation').'</div>';} ?>
                    <div>cURL:</div>
                    <?php if (in_array ('curl', get_loaded_extensions())):?>
                     ...
                     <?php endif; ?>
                    <?php if ( $db_check == 1 ):?>
                        <div><?php echo $Translate->get_translate_module_phrase('module_page_pay','_DBCheckConnect')?></div>
                    <?php elseif( $db_check == 2 ): ?>
                        <div><?php echo $Translate->get_translate_module_phrase('module_page_pay','_DBCheckConnectSucc')?></div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
