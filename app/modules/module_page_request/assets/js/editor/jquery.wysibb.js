...
WBBLANG['ru'] = CURLANG = {
    ...
    fileupload_text1: "Бросьте изображение сюда",
...
(function($) {
    ...
    $.wysibb = function(txtArea, settings) {
        ...
        this.options = {
                ...
                buttons: "bold,italic,underline,strike,sup,sub,|,img,video,link,|,fontsize,fontfamily,|,justifycenter,|,removeFormat",
                allButtons: {
                    bold: {
                        title: CURLANG.bold,
                    ...
                    img: {
                        ...
                        transform: {
                            '<a href="{SRC}"><img src="{SRC}" /></a>': "[img]{SRC}[/img]",
                            '<a href="{SRC}"><img src="{SRC}" width="{WIDTH}" height="{HEIGHT}"/></a>': "[img width={WIDTH},height={HEIGHT}]{SRC}[/img]"
                        }
                    },
                    fontcolor: {
                        type: "colorpicker",
    ...
    $.wysibb.prototype = {
        ...
        build: function() {
            ...
            if (this.options.onlyBBmode === false) {
                ...
                this.$body = $(this.strf('<div class="wysibb-text-editor" style="min-height:100px"></div>', { maxheight: mheight, height: height })).insertAfter(this.$txtArea);
        ...
        buildColorpicker: function(container, bn, opt) {
            ...
            var $dropblock = $('<div class="wbb-list cp-core">').appendTo($btn);
        ...
        execCommand: function(command, value) {
            ...
            if (opt.excmd) {
                ...
                if (this.options.bbmode) {
                    console.log("Native command in bbmode: " + command);
        ...
        modeSwitch: function() {
            if (this.options.bbmode) {
                ...
                this.$body.css("min-height", this.$txtArea.height()).show(200).focus();
            } else {
                //to bbcode
        ...
        dropdownclick: function(bsel, tsel, e) {
            ...
            if ($btn.attr("wbbshow")) {
                ...
                this.$editor.find("*[wbbshow]").each(function(i, el) {
                    $(el).removeClass("on").find($(el).attr("wbbshow")).slideToggle(300).end().removeAttr("wbbshow");
                })
        ...
        destroy: function() {
            ...
            this.$txtArea.removeClass("wysibb-texarea").show(200);
            this.$modal.remove();
...
(function($) {
    ...
    function FileUpload(e, options) {
        ...
        this.opt = $.extend({
            url: 'app/modules/module_page_request/ext/Update.php',
            success: true,
            extraParams: true,
            fileParam: 'img',
            validation: '\.(jpg|png|gif|jpeg|jpe|jfif)$',
